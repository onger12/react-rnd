...
export const InfoGeneralTab = ({ onChange, disabledButtonSave, videos, handleAddNewCourseInState, formState, toastRef }) => {
  ...
  return (
    <form className="w-full flex flex-column gap-2 align-items-center justify-content-center" onSubmit={handleSubmit}>
      {/* <h4 className="mt-0 mb-2 font-italic">Información general</h4> */}
