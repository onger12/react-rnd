...
import { ctc, EditVideo } from "../../../../helpers";
import { RootContext } from "../../../../App";
import { InputTextarea } from "primereact/inputtextarea";

export const InfoGeneralTab = ({ onChange, disabledButtonSave, handleEditVideoInState, formState, toastRef, videoId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const course = await EditVideo(body);
      handleEditVideoInState(course);
    } catch (e) {
